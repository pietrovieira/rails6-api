...
class SubcategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post subcategories_url, params: { subcategory: { active: @subcategory.active, category_id: @subcategory.category_id, description: @subcategory.description, label: @subcategory.label } }
    end
  ...
  test "should update subcategory" do
    patch subcategory_url(@subcategory), params: { subcategory: { active: @subcategory.active, category_id: @subcategory.category_id, description: @subcategory.description, label: @subcategory.label } }
